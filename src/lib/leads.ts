 ...
 * riêng theo IP. Trang landing build tĩnh (không có server runtime), vì vậy
 * request đi thẳng từ browser — origin của landing phải nằm trong
...
const BASE = (import.meta.env.PUBLIC_API_BASE ?? "").trim().replace(/\/$/, "");
